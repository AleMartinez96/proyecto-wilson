...
public class EditarDatos extends JPanel {
    ...
    private void btnListener() {
        btnActualizar.addActionListener(_ -> {
            setComboBox(ventanaPrincipal.getListaMembresia());
            actualizarDatos();
        });
    ...
    private void actualizarDatos() {
        List<JComponent> components = List.of(txtApellido, txtNombre, txtCalle,
                ...
                calendarioInicio, txtMonto, cbxMembresia);
    ...
    private void seleccionarCombo() {
        List<String> lista = ventanaPrincipal.getListaMembresia();
    ...
    private void initComponents() {
        ...
        btnActualizar.setFont(new java.awt.Font("Roboto", 2, 14)); // NOI18N
