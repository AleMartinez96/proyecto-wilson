...
public class EditarDatosCliente extends PanelBase implements ControladorDeValidacionYComponentes {

    private Cliente cliente;
    private final VentanaPrincipal ventanaPrincipal;

    public EditarDatosCliente(VentanaPrincipal ventanaPrincipal) {
        initComponents();
